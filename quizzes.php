...
<head>
    ...
    <title>Study Buddy - My Quizzes</title>
...
<body>
    ...
    <nav id="navbar">
        ...
        <div class="nav-links" id="nav-links">
            <?php if (isset($_SESSION['user_id'])): ?>
                ...
                <a href="quizzes.php" class="cta-button primary <?php echo ($currentPage == 'quizzes.php') ? 'active' : ''; ?>">My Quizzes</a>
    ...
    <div class="dashboard-container">
        <div class="dashboard-card">
            ...
            <p class="welcome-message">Test your knowledge with these quizzes!</p>

            <div class="quizzes-list">
                <div class="quiz-item">
                    <h3>Mathematics Basics</h3>
                    <p>Questions: 10 | Difficulty: Easy</p>
                    <div class="quiz-actions">
                        <a href="#" class="cta-button primary small">Start Quiz</a>
                        <a href="#" class="cta-button secondary small">Review</a>
                    </div>
                </div>
                <div class="quiz-item">
                    <h3>History of Ancient Rome</h3>
                    <p>Questions: 15 | Difficulty: Medium</p>
                    <div class="quiz-actions">
                        <a href="#" class="cta-button primary small">Start Quiz</a>
                        <a href="#" class="cta-button secondary small">Review</a>
                    </div>
                ...
                <div class="quiz-item">
                    ...
                    <p>Questions: 20 | Difficulty: Hard</p>
                    <div class="quiz-actions">
                        <a href="#" class="cta-button primary small">Start Quiz</a>
                        <a href="#" class="cta-button secondary small">Review</a>
                    </div>
            ...
            <button class="cta-button primary large" style="margin-top: 1rem;"><i class="fas fa-plus"></i> Create New Quiz</button>
    ...
    <script>
        ...
        try {
            history.replaceState({page: 'quizzes'}, '', location.href);
